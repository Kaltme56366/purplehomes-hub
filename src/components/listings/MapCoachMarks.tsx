...
const TOUR_STEPS = [
  ...
  {
    id: 9,
    selector: '[data-tour="card-pricing"]',
    title: 'Price & Down Payment',
    description: 'See the listing price and required down payment at a glance on each property card.',
    position: 'right' as const,
  },
  {
    id: 10,
    selector: '[data-tour="card-specs"]',
    title: 'Beds, Baths & Size',
    description: 'Quickly compare bedrooms, bathrooms, and square footage across listings.',
    position: 'bottom' as const,
  },
  {
    id: 11,
    selector: '[data-tour="card-location"]',
    title: 'Address & Location',
    description: 'View the property address and city. Click the card to see full details including state and ZIP code.',
    position: 'bottom' as const,
  },
  {
    id: 12,
    selector: '[data-tour="card-save"]',
    title: 'Save Properties',
    description: 'Click the heart icon to save properties you\'re interested in for easy access later.',
    position: 'left' as const,
  },
  {
    id: 13,
